...
namespace Planner.Tests.TestDal.Appointments {
    public class AppointmentTestDao : IAppointmentDao {
        ...
        public int CreateAppointment(AppointmentDto appointmentDto) {
            AppointmentDto actualAppointmentDto = new AppointmentDto(IdAutoIncrement++, appointmentDto.Title, appointmentDto.Description, appointmentDto.StartDate, appointmentDto.EndDate, appointmentDto.Finished, appointmentDto.Priority, appointmentDto.Participants);
